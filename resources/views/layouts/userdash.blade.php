    ...
    <div class="relative flex justify-end items-center gap-x-4 mb-9">
            ...
            <div class="absolute top-4 right-4 relative">
                ...
                <div id="profileDropdown"
                    ...
                    <div class="block">
                        ...
                        <a href="/profile" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">My
                            Profile</a>
                        ...
                        <a href="/user/reset-password"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Reset
                            Password</a>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const resetPassword = localStorage.getItem('password_reset');
                if (successMessage) {
                ...
                if (resetPassword) {
                    // Show the notification
                    showPopup(resetPassword, "success");
