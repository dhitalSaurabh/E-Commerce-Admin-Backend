  ...
  <footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      <div class="md:flex md:justify-between">
        <!-- 🛍️ Logo -->
        <div class="flex-shrink-0 flex items-center py-5">
          <a href="/" class="text-2xl font-bold text-blue-600 hover:text-gray-700">
            <i class="fas fa-shopping-bag mr-2"></i>E-Shop
          </a>
        </div>
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
              <li class="mb-4">
                <a href="https://flowbite.com/" class="hover:underline">E-Shop</a>
              </li>
              <li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/"
            class="hover:underline">E-Shop™</a>. All Rights Reserved.
        </span>
