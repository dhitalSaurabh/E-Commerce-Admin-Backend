...
{{-- <x-layout> --}}
    ...
    <p class="mt-6 text-center text-sm text-gray-700">
        Already have an account? <a href="{{ url('/authuser/login') }}" class="text-indigo-600 hover:underline font-medium">Login here</a></p>
    <script src="{{ asset('js/user/register-user-api.js')}}"></script>
{{-- </x-layout> --}}
@endsection